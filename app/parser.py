...
openTSDBPath = config["openTSDB"]["path"]
...
if __name__ == "__main__":
    ...
    while(True):
        ...
        try:
            ...
            subprocess.call([openTSDBPath,"uid","delete","metrics","TopKDomains"])
            successDomain = 1
        ...
        try:
            ...
            subprocess.call([openTSDBPath,"uid","delete","metrics","TopKClients"])
            successClient = 1
        except TimeOutException:
            print("HTTP Query takes too long")
